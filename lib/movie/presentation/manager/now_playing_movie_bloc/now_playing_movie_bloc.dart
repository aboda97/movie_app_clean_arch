...
import 'package:movie_app/movie/presentation/manager/now_playing_movie_bloc/now_playing_movie_states.dart';
  ...
  NowPlayingMovieBloc(this.getNowPlayingUseCase)
    ...
    on<NowPlayingMovieEvent>((event, emit) async {
      if (event is NowPlayingEventSuccess) {
        ...
        final result =
            await GetNowPlayingUseCase(sl<BaseMovieRepo>()).nowPlayingExcute();
